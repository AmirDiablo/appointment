...
const Navbar = () => {
    ...
    return ( 
        ...
        <div className="flex items-center">
            ...
            <button onClick={()=> navigate("/login")} className="bg-primary text-white hover:cursor-pointer px-8 py-3  rounded-full font-light hidden md:block">Create account</button>}
